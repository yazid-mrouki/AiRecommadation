...
_DEFAULT_RULES = [
 ...
 {"categorie":"electronique","attributs_similaire":"module_fn","complement_categories":"carte;connectique;composant;alimentation","complement_categories_toutes":"","complement_mots_cles":"arduino;raspberry;esp32;dupont;breadboard;resistance;led;potentiometre;support;afficheur;ecran;lcd;oled;module;relais;capteur;alimentation","exclure_mots_cles":"foret;perceuse;vis;cle;douille;peinture;fpga;altera;cyclone;projecteur;clé à chocs","exemple":"Relais/LCD/Module -> Arduino / dupont / resistance / afficheur"},
